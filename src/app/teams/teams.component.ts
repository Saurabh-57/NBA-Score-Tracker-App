...
export class TeamsComponent implements OnInit {
  public teams: Teams[] = [];
  public teamsSelected: IResults[] = [];
  public dropdownSelected: number = 0;
  public headerInfo: Teams[] = [];
  constructor(private scoreService: CustomScoreService, private router: Router) { }
  ...
  public track() {
    this.scoreService.getTeamResults(this.dropdownSelected).subscribe((response: IResults) => {
  ...
  getAverage(item: IResults[], property: string) {
    let sum = 0;
    item.forEach((key) => {
